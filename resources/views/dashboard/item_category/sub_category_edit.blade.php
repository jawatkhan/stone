@extends('layouts.app')
@section('page_title',__('general.usub-category'))
@section('content')
...
<div class="panel-body">
	<form class="form-horizontal" action="{{ URL::to('/sub-category-update') }}" method="post">
		{{ csrf_field() }}
		@section('editmethod')
		@show
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
              <button type="submit" class="btn btn-success btn-sm">{{__('button.save')}}</button>
            </div>
        </div>
	</form>
</div>
