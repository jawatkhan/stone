			...
			<div class="modal-body">
				<form class="form-horizontal" role="form" action="" method="GET" id="editextraCost">
                        ...
                        <div class="row">
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-default date" placeholder="@lang('form.date')" name="date" id="datepicker1" value="{{date('Y-m-d')}}">
					...
					<div class="row modal-footer">
						<button type="button" id="updateExtraCostSubmit" class="btn btn-success btn-prime white btn-lg">@lang('button.update')</button>
