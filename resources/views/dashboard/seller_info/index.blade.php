@extends('layouts.app')
@section('page_title',__('general.buyer-information'))
                    ...
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$data->org_name}}</td>
                                <td>{{$data->address}}</td>
                                <td>{{bfn($data->contact_no)}}</td>
                                <td>{{$data->email}}</td>
                                <td>
                                    @can('update-data')
                                	<input type="button" id="editSeller" data-toggle="modal" data-target="#editSellerInfo" data-id="{{$data->id}}" class="btn btn-lg btn-info" value="{{__('button.edit')}}">
                                    @endcan
                                    @can('delete-data')
                                	<input id="seller-dell" type="button" data-id="{{$data->id}}" class="btn btn-lg btn-danger btn-prime white" value="{{__('button.delete')}}">
                                    @endcan
                                </td>
                            </tr>
                            @endforeach
...
@include('dashboard.seller_info.editSellerinfoModal')
@endsection
@section('script')
