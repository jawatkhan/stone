                    ...
                    <table id="" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('table.total-paid-amount')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(count($depo)>0)
                                    {{bfn($data->total_sales-$depo[0]->total_deposit)}}
                                    @else
                                    {{bfn($data->total_sales)}}
                                    @endif
                                </td>
                            </tr>
                            @endforeach
