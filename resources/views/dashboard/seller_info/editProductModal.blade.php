    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" action="" method="GET" id="product-edit">
                    {{ csrf_field() }}
                    @section('editmethod')
                    @show
                    <div class="hidden">
                    ...
                    <div class="row modal-footer">
                        <button type="button" id="editProductSubmit" class="btn btn-success btn-prime white btn-lg">{{__('button.add')}}</button>
