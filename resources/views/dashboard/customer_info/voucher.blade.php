        ...
        <div class="card" id="printableArea">
        	<div class="row">
        		<div class="col-md-12 purcheseCashMemo">
        			...
        			<h2>@lang('general.sales-cash-memo')</h2>
        	   </div>
		                    ...
		                    <table class="table table-striped table-bordered voucherTable">
		                        ...
		                        <tbody>
		                            ...
		                            @if(count($extraCost)>0)
		                            	...
		                            	<tr>
		                            		<td>{{ bfn($sl++) }}</td>
		                            		<td colspan="2">{{$data->owner_id==1?__('table.own'):__('table.seller')}}</td>
		                        ...
		                        <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="5" style="text-align:right;">@lang('table.receive-taka')</th>
                                        <th style="text-align:right;">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="5">
                                            {{ (($ptotal-$dtotal) > 0) ? App\Libraries\Library::numToWord(number_format($ptotal-$dtotal,2,'.','')) : App\Libraries\Library::numToWord(number_format($dtotal,2,'.','')) }} @lang('table.taka-only')
                                        </th>
                                    </tr>
		                        </tfoot>
		                    </table>
