	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="exampleModalLabel">@lang('general.ucustomer-information')</h3>
				    	...
				    	<div class="row">
                    		<div class="col-md-6">
                    			<div class="form-group">
							        ...
							        <input type="text" class="form-control input-default " placeholder="@lang('form.customer-name')" name="new_org_name" id="new_org_name">
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
							        ...
							        <input type="email" class="form-control input-default " placeholder="@lang('form.customer-email')" name="seller_email" id="seller_email">
                    	...
                    	<div class="row">
                    		<div class="col-md-6">
                    			<div class="form-group">
							        ...
							        <input type="text" class="form-control input-default " placeholder="@lang('form.customer-address')" name="seller_address" id="seller_address">
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
							        ...
							        <input type="text" class="form-control input-default " placeholder="@lang('form.customer-phone')" name="seller_contact_no" id="seller_contact_no">
