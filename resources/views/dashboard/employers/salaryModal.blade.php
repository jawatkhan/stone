<div class="modal fade" id="salaryAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="exampleModalLabel">@lang('general.employer-salary-payment')</h3>
				<button type="button" class="close btn-lg" data-dismiss="modal" aria-hidden="true" style="padding-top: 8px;">&times;</button>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" role="form" action="" method="GET" id="add_salary">
					{{ csrf_field() }}
					@section('editmethod')
					@show
                        <div class="row">
                    		...
                    		<div class="col-md-4">
                    			<div class="form-group">
							        ...
							        <input type="text" class="form-control input-default " name="payment_date" id="datepicker1" value="{{date('Y-m-d')}}">
					...
					<div class="row modal-footer">
						<button type="button" id="salarySubmit" class="btn btn-success btn-prime white btn-lg">@lang('button.add')</button>
