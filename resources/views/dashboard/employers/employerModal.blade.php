	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="exampleModalLabel">@lang('general.add-employer')</h3>
				<button type="button" class="close btn-lg" data-dismiss="modal" aria-hidden="true" style="padding-top: 8px;">&times;</button>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" role="form" action="" method="GET" id="employer_Add">
					{{ csrf_field() }}
					@section('editmethod')
					@show
					...
					<div class="row modal-footer">
						<button type="button" id="employerSubmit" class="btn btn-success btn-prime white btn-lg">@lang('button.add')</button>
